...
public class BookList extends AppCompatActivity {
    ...
    //creating method to display the menu
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuInflater menuInflater = getMenuInflater();
        menuInflater.inflate(R.menu.mune_list, menu);
        return super.onCreateOptionsMenu(menu);
    }
    //To select somthing from the menu
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //if the search query is not empty then we are calling get book
                // info method to load all the books from the API.
    ...
    private void getBooksInfo(String query) {
        ...
        mRequestQueue = Volley.newRequestQueue(BookList.this);
        ...
        JsonObjectRequest booksObjrequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < itemsArray.length(); i++) {
                        ...
                        BookAdapter adapter = new BookAdapter(bookInfoArrayList, BookList.this);
                        //below line is use to add linear layout manager for our recycler view.
                        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(BookList.this, RecyclerView.VERTICAL, false);
                    ...
                    Toast.makeText(BookList.this, "No Data Found" + e, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(BookList.this, "Error found is " + error, Toast.LENGTH_SHORT).show();
            }
        });
